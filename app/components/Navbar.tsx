		...
		>
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex justify-between h-16">
					...
					<div className="hidden custom-md:flex md:items-center md:space-x-6 text-base sm:text-lg">
						<Link
							href="#about"
			...
			{isOpen && (
				<div className="custom-md:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
